...
| Fields | |
| :--- | :--- |
| [ApiUrl](SHTCGClient.ClientService.ApiUrl.md 'SHTCGClient\.ClientService\.ApiUrl') | |
...
| [GetCsrf\(\)](SHTCGClient.ClientService.GetCsrf().md 'SHTCGClient\.ClientService\.GetCsrf\(\)') | |
...
| [Handshake\(\)](SHTCGClient.ClientService.Handshake().md 'SHTCGClient\.ClientService\.Handshake\(\)') | |
...
| [Logout\(\)](SHTCGClient.ClientService.Logout().md 'SHTCGClient\.ClientService\.Logout\(\)') | |
...
| [SendAsync\(HttpRequestMessage\)](SHTCGClient.ClientService.SendAsync(System.Net.Http.HttpRequestMessage).md 'SHTCGClient\.ClientService\.SendAsync\(System\.Net\.Http\.HttpRequestMessage\)') | |
